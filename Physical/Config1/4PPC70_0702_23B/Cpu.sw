...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  <TaskClass Name="Cyclic#1">
    <Task Name="Caliz51" Source="Visuuu_.Caliz51.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
  <TaskClass Name="Cyclic#2" />
  <TaskClass Name="Cyclic#3" />
  <TaskClass Name="Cyclic#4">
    <Task Name="FanAnimati" Source="Sources.FanAnimation.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
  ...
  <VcDataObjects>
    <VcDataObject Name="Visu" Source="Visuuu_.Visu.dob" Memory="UserROM" Language="Vc" WarningLevel="2" />
  </VcDataObjects>
  <Binaries>
